...
export default class ListItem extends Component {
    ...
    render() {
        ...
        return (
                <li className="list-group-item shadow-sm d-flex justify-content-between col-12 mx-auto border-start mb-2 border-primary border-0 border-2 rounded align-items-start">
